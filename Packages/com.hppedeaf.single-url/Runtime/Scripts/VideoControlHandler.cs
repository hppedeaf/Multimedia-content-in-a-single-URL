...
#pragma warning restore CS0649
        ...
        public void SetLocked(bool locked)
        {
            if (locked)
            {
                ...
                if (Networking.IsOwner(targetVideoPlayer.gameObject) || targetVideoPlayer.CanControlVideoPlayer())
                {
                    ...
                    if (urlFieldPlaceholderText) urlFieldPlaceholderText.text = "Enter URL...";
                }
                else
                {
            ...
            else
            {
                ...
                if (lockGraphic) lockGraphic.color = whiteGraphicColor;
                if (urlFieldPlaceholderText) urlFieldPlaceholderText.text = "Enter URL... (anyone)";
            }
        }
        ...
        public void SetToImagePlayerMode()
        {
            if (syncController)
        ...
        public void OnImagePlayerModeButtonPressed()
        {
            targetVideoPlayer.SetToImagePlayer();
        }
